<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="FacturasPagadas.aspx.cs" Inherits="tarea3BD.FacturasPagadas" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <!--Parte de grid con los datos de busqueda-->
<h3 class="text-center text-primary mb-4">Facturas Pagadas</h3>
